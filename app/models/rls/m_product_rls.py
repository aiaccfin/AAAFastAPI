...
class ProductUpdate(SQLModel):
    """Update model - type, initial_quantity, and initial_quantity_date are NOT allowed to edit"""
    ...
    # initial_quantity, and initial_quantity_date are NOT changeable via update
